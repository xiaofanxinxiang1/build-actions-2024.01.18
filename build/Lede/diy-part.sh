...
# 后台IP设置
export Ipv4_ipaddr="10.10.1.26"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="OpenWrt-xf"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
# 旁路由选项
export Gateway_Settings="10.10.1.1"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
